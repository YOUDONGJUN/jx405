...
import day0110.Ex04Gradebook02;
...
public class Ex12Gradebook03_hw {
    ...
    static day0110.Student[] s = new day0110.Student[5];
...
//                }
    ...
    public static void printInfo(day0110.Student[] s) {
        for (int i = 0; i < 5; i++) {
            System.out.printf("번호 : %d번, 이름: %s\n", s[i].id, s[i].name);
            System.out.printf("국어 점수 : %d점, 영어 점수 : %d점, 수학 점수 : %d점\n", s[i].korean, s[i].english, s[i].math);
            System.out.printf("총점 : %d점, 평균 : %.2f점\n", day0110.Ex04Gradebook02.calculateSum(s[i]), Ex04Gradebook02.calculateAverage(s[i]));
        }
    }
