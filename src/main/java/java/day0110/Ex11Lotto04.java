...
public class Ex11Lotto04 {
    ...
    public static void main(String[] args) {
        ...
        day0110.Ex10Lotto03.setAutoNumbers(computerNumbers);
        day0110.Ex10Lotto03.sort(computerNumbers);
    ...
    public static void setNumbers(int[][] arrays) {
        for (int i = 0; i < arrays.length; i++) {
            ...
            if (userChoice == 1) {
                day0110.Ex10Lotto03.setAutoNumbers(arrays[i]);
            } else {
                day0110.Ex10Lotto03.setManualNumbers(arrays[i]);
            }

            day0110.Ex10Lotto03.sort(arrays[i]);
        }
    }
