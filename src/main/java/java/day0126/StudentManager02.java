...
public class StudentManager02 {
    ...
    // insert()
    static void insert() {
        day0126.Student s = new day0126.Student();
    ...
    public static void printList() {
        ...
        try {
            ...
            ArrayList<day0126.Student> list = selectAll();

            if (list.isEmpty()) {
                System.out.println("아직 등록된 학생이 존재하지 않습니다.");
            } else {
                for (day0126.Student s : list) {
    ...
    public static ArrayList<day0126.Student> selectAll() {
        ArrayList<day0126.Student> list = new ArrayList<>();
    ...
    static day0126.Student selectOne(int id) {
