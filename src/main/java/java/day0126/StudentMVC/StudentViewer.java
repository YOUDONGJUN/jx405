...
public class StudentViewer {
    ...
    public StudentViewer(Scanner scanner) {
        ...
        studentController.pstmt = this.pstmt;
        studentController.connection = this.connection;
        studentController.resultSet = this.resultSet;
...
//        StudentDTO s = new StudentDTO();
        ...
        try {
            ...
            ArrayList<StudentDTO> list = studentController.selectAll(pstmt, connection, resultSet);
            ...
            if (list.isEmpty()) {
                ...
                while (userChoice != 0 && studentController.selectOne(userChoice, pstmt, connection, resultSet) == null) {
    ...
    public void printOne(int id) {
        StudentDTO s = studentController.selectOne(id, pstmt, connection, resultSet);
        s.printInfo();
