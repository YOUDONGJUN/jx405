...
<head>
    ...
    <link rel="stylesheet" href="/web/css/customer/findIdPassword.css"/>
        ...
        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="findId-tab" data-bs-toggle="tab" data-bs-target="#findId"
                        type="button" role="tab" aria-controls="findId" aria-selected="true">아이디 찾기
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="findPassword-tab" data-bs-toggle="tab" data-bs-target="#findPassword"
                        type="button" role="tab" aria-controls="findPassword" aria-selected="false">비밀번호 찾기
                </button>
            </li>
        </ul>
                ...
                <form id="form-findId">
                    ...
                    <div class="row p-0 row-top">
                        ...
                        <div class="col-9 align-self-center">
                            <input type="text" class="form-control" id="input-findId-name" name="name" placeholder="이름"
                                   maxlength="17"/>
                        </div>
                    </div>
                    <div class="row p-0 row-other">
                        ...
                        <div class="col-9 align-self-center">
                            <input type="text" class="form-control" id="input-findId-birthDate" name="birthDate"
                                   placeholder="생년월일 앞8자리" maxlength="8"/>
                        </div>
                    </div>
                    ...
                    <div class="row p-0 row-other">
                        ...
                        <div class="col-9 align-self-center">
                            <input type="text" class="form-control" id="input-findId-phoneNumber" name="phoneNumber"
                    ...
                    <div class="row mt-4">
                        <div class="d-grid col-6 mx-auto">
                            <button id="btn-findId" type="button" class="btn btn-primary btn-lg" disabled>아이디 찾기
                            </button>
                        </div>
                    </div>
                </form>
            ...
            <div class="tab-pane" id="findPassword" role="tabpanel" aria-labelledby="findPassword-tab">
                <form id="form-findPassword" action="/customer/resetPasswordForm" method="post">
                    ...
                    <div class="row p-0 row-top">
                        ...
                        <div class="col-9 align-self-center">
                            <input type="text" class="form-control" id="input-findPassword-id" name="id"
                    ...
                    <div class="row p-0 row-other">
                        ...
                        <div class="col-9 align-self-center">
                            <input type="text" class="form-control" id="input-findPassword-name" name="name"
                                   placeholder="이름" maxlength="17"/>
                        </div>
                    </div>
                    <div class="row p-0 row-other">
                        <div class="col-3 m-0 ps-3 py-3 col-label">
                        ...
                        <div class="col-6 align-self-center">
                            <input type="text" class="form-control" id="input-findPassword-phoneNumber"
                                   name="phoneNumber" placeholder="'-' 없이 입력" maxlength="11"/>
                        </div>
                        <div class="col-3 align-self-center">
                            <button id="btn-request-authentication" type="button" class="btn btn-primary" disabled>
                                인증요청
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="row p-0 row-other">
                        ...
                        <div class="col-6 align-self-center position-relative">
                            ...
                            <span id="span-remainTime" class="position-absolute top-50 translate-middle-y"
                                  hidden></span>
                        </div>
                        <div class="col-3 align-self-center">
                            <button type="button" id="btn-check-authentication" class="btn btn-primary" disabled>인증확인
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="d-grid col-6 mx-auto">
                            <button id="btn-findPassword" type="submit" class="btn btn-primary btn-lg" disabled>비밀번호
                                찾기
                            </button>
                        </div>
                    </div>
...
<script src="/web/js/customer/BirthDateValidation.js"></script>
