    ...
    <div class="content-wrap mx-auto">
        ...
        <form id="form-signUp">
            ...
            <div class="row p-0 row-other">
                ...
                <div class="col-9 align-self-center">
                    <input type="text" id="input-name" class="form-control" name="name" placeholder="이름"
                           maxlength="17"/>
                </div>
            </div>
            <div class="row p-0 row-other">
            ...
            <div class="row p-0 row-other">
                ...
                <div class="col-9 align-self-center">
                    <input type="text" class="form-control" id="input-email" name="email" placeholder="이메일 주소를 입력해주세요."
                           maxlength="330"/>
                </div>
            </div>
            <div id="div-email-error" class="row p-0 ro
				w-other" hidden>
                <div class="col-3 m-0 ps-3 py-3 col-label"></div>
                <div class="col-9 align-self-center">
