            ...
            <form id="qnaForm" action="/qna" method="post" enctype="multipart/form-data">
                <table class="table mt-3">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="userName" value="${LOGIN_USER.name }" class="form-control"
                                   maxlength="15"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="textarea">
                                <textarea class="form-control" name="content" id="textarea" rows="5" cols="30"
                                          maxlength="1000"
                                          placeholder="※ 불편사항이나 문의사항을 남겨주시면 최대한 신속하게 답변 드리겠습니다."></textarea>
                            </div>
                        </td>
                    </tr>
                    <tr>
