            ...
            <div class="row">
                <div class="offset ms-4 col-7 p-0" style="margin-left: 20px;">
                    ...
                    <div class="rounded row p-3 mb-3">
                        ...
                        <div class="col-2">
                            <button type="button" class="btn btn-primary btn-sm" style="margin-top: 34px;"
                                    id="btn-search">검색
                            </button>
                        </div>
                    </div>
                    <div>
                        <nav>
                            <div class="nav nav-tabs nav-justified mt-3" id="nav-tab" role="tablist">
                                <button class="nav-link active faq-list" name="option" value="전체" id="nav-all-tab"
                                        data-bs-toggle="tab" data-bs-target="#nav-all" type="button"
                                        role="tab" aria-controls="nav-all" aria-selected="true">전체
                                </button>
                                <button class="nav-link faq-list" name="option" value="예매" id="nav-ticket-tab"
                                        data-bs-toggle="tab" data-bs-target="#nav-ticket" type="button" role="tab"
                                        aria-controls="nav-ticket" aria-selected="false">영화예매
                                </button>
                                <button class="nav-link faq-list" name="option" value="극장" id="nav-theater-tab"
                                        data-bs-toggle="tab" data-bs-target="#nav-theater" type="button" role="tab"
                                        aria-controls="nav-theater" aria-selected="false">극장
                                </button>
                            </div>
                        </nav>
                    </div>
                    ...
                    <div id="faq-lists" class="tab-content" id="nav-tabContent">
                        ...
                        <div class="ms-4 tab-pane fade" id="nav-ticket" role="tabpanel"
                             aria-labelledby="nav-ticket-tab">
                            <div class="row mt-3 faq">
                            </div>
                        </div>
                        <div class="ms-4 tab-pane fade" id="nav-theater" role="tabpanel"
