        ...
        <div class="container">
            <div class="row" id="movie-head">
                <div class="col ms-3 mt-5 mb-5">
                    ...
                    <div class="row" style="margin-top: 310px;">
                        ...
                        <div class="col-3 rating-top">
                            <p>예매율</p>
                            <img alt="" src="../images/movie/ico-ticket-gray.png">
                            <span class="rating">-</span>
                        </div>
                        <div class="col-3 audience-top">
                            <p>누적관객수</p>
                            <img alt="" src="../images/movie/ico-person.png">
                ...
                <div class="col mt-5 mb-5">
                    ...
                    <button type='button' class='ticketing btn btn-primary mt-3 float-end'><a
                            href="../ticketing/screenList.jsp?no=${param.no }">예매</a></button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="tab-pane fade show active" id="nav-main" role="tabpanel"
            ...
            <div class="row mt-5 mb-5 ms-1">
                <div class="col">
                    ...
                    <br><span>장르: </span><span id="genre"></span> <span id="runtime"></span>분 | 개봉일: <span
                        id="openDt"></span><br> <span>출연진:
            ...
            <div id="all-movie-graph" class="row border p-4 mt-5 mb-5">
                <div class="col border-end" style="text-align: center;">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <!-- 데이터 없을 때 -->
                        <div class="no-graph1">
                            <img alt="" src="../images/movie/no-graph01.jpg">
                        </div>
                    </div>
                </div>
                <!-- 평점 그래프 -->
                <div class="col border-end" style="text-align: center;">
                    ...
                    <div class="no-graph2">
                        <img alt="" src="../images/movie/no-graph02.jpg">
                    </div>
                </div>
                <div class="col" style="text-align: center;">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <!-- 데이터 없을 때 -->
                        <div class="no-graph3">
                            <img alt="" src="../images/movie/no-graph03.jpg">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <h4>
                    <span class="title2"></span><span class="no-review" style="font-size: 18px;">에 대한 <span
                        class="reviewCount"></span>개의 이야기가 있어요!</span>
                </h4>
            </div>
                    ...
                    <c:choose>
                        <c:when test="${not empty LOGIN_USER }">
                            <a data-bs-toggle="modal" data-bs-target="" href="" class="review-btn">
                                <img alt="" src="../images/movie/ico-story-write.png"> 관람평 쓰기 </a>
                        </c:when>
                        <c:otherwise>
                            <img alt="" src="../images/movie/ico-story-write.png"><span
            ...
            <div class="row">
                <div class="movie-sorting text-end">
                    <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                        <input type="radio" class="btn-check" name="option" value="date" id="date" autocomplete="off"
                               checked>
                ...
                <form id="review-form" method="post" action="">
                    ...
                    <div class="border p-3 bg-light mb-3">
                        ...
                        <div class="row mt-3 p-2">
                            <textarea id="review-content" placeholder="실관람평을 남겨주세요." class="form-control"
                                      name="reviewContent" id="content" rows="3" maxlength="100"></textarea>
                        </div>
                    </div>
                    <div class="text-center mt-2 mb-3">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                    <c:forEach var="point" items="${pointTypes }" varStatus="loop">
                                        <div class="review-point-circle">
                                            <input type="checkbox" name="pointNo" value="${point.no }" class="btn-check"
                                                   id="btncheck-${loop.count }" autocomplete="off">
                                            <label class="circle-box"
                                                   for="btncheck-${loop.count }">${point.pointName }</label>
                                        </div>
                                    </c:forEach>
                                </div>
                            </div>
            ...
            $.getJSON('/rest/review', {page: currentPageNo, option: order, movieNo: movieId}, function (response) {
                ...
                if (reviews == "") {
                    ...
                    $.each(reviews, function (index, review) {
                        ...
                        output += "<img src='../images/movie/bg-photo.png' style='width: 50px;'><br>"
                    ...
                    if (myReview == reviewNo) {
                        utilbtn += `<button type='button' class='btn util-btn dropdown-toggle' id='utils' data-bs-toggle='dropdown' aria-expanded='false'>
										<img src='../images/movie/btn-alert.png'>
									</button>
