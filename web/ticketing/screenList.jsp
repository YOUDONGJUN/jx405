...
<head>
    ...
    <link rel="stylesheet" href="/web/css/screenList.css">
            ...
            <div class="movie-container">
                <div class="left-one">
                    ...
                    <div class="movie-list">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <c:forEach var="movie" items="${movies}">
                                    <button class="movie-button ${movie.movieNo eq param.no ? 'active' : '' }"
                ...
                <div class="center-one">
                    ...
                    <div class="list-theater-detail">
                        ...
                        <div class="theater-choices">

                        </div>
                    </div>
                    <div class="theater-choices-check">
    ...
    $(function () {
        ...
        $('button.movie-button').click(function () {
            ...
            if ($movieButton.hasClass('active')) {
                ...
                $('#picture').attr('src', '/web/images/movie/no-graph03.jpg');
        ...
        $('button.list-theater-button').click(function () {
            let $dataAttr = $('div.theater-choices');
            $dataAttr.empty();
        ...
        //극장명을 클릭하면
        $('div.theater-choices').on('click', 'button.list-theater-button', function () {
            ...
            let $theaterNames = $('div.theater-choices');
            $.getJSON('/rest/theaterList', {
                movieNo: movieNo,
                theaterNo: theaterNo,
                timeNo: timeNo,
                dayNm: dayNm
                ...
                $.each(response.items, function (index, theater) {
                    ...
                    let listputs = "<button class='theater-choices-button'>" + theater.theaterName + "</button>";
