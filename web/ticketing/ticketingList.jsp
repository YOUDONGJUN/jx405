        ...
        <div class="right-container">
            <div class="movie-container">
                <div class="title-area">
                    <span class="movie-grade" data-ratiedNo="${ratied.ratingNo }"><img src="${ratied.ratingImageURL }"
                                                                                       alt="12age"
                                                                                       class="img-age"/></span>
                ...
                <div class="movie-detail-area">
                    ...
                    <p class="date"><span><fmt:parseDate value="${ticketingDay }" var="dateString"
                                                         pattern="yyyy-MM-dd"/>
                    ...
                    <div class="other-time">
                        <button type="button" class="now-time">
                            <span>영화 시작 시간<fmt:formatDate value="${screens.showScheduleStartTime }" var="dataClock"
                                                          pattern="HH:mm"/>${dataClock }</span>
                        </button>
                        <ul>
                ...
                <div>
                    <div class="kind-seat">
                        <div class="seat-condition-choice" title="선택한 좌석"><em class="seat-em">선택</em></div>
                ...
                <div class="btn-group">
                    ...
                    <c:choose>
                        <c:when test="${empty LOGIN_USER }">
                            <a href="#" class="button" id="pageNext-1" data-bs-toggle="modal"
...
<script type="text/javascript">
        ...
        if (who === '성인 좌석 선택 감소') {
            ...
            if (textAdult.match("성인") == "성인") {
                ...
                if (minusbtn == 0) {
                    ...
                    $('input.seat-condition-choice').attr('class', 'seat-condition-common');
                    totalSeat = 0;
                }
    ...
    $('div#show-seat').on("click", "input[type=button].seat-condition-common", function () {
        ...
        if (titleSeat.match('구매가능') == "구매가능") {
            ...
            $seat.attr('class', 'seat-condition-choice');
            $seat.css('color', 'gray');
            $('input[name=seat-No' + totalSeat + ']').val($seat.val());
            totalSeat++;
        }
    })
    $('div#show-seat').on("click", "input[type=button].seat-condition-choice", function () {
        let $choicesSeat = $(this);
        let valueString = $choicesSeat.val();
        $choicesSeat.attr('class', 'seat-condition-common');
        $choicesSeat.css('color', 'white');
