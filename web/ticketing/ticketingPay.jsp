        ...
        <div class="pay-container">
            <div class="kind-age">
                ...
                <c:forEach var="number" items="${ticketAudience }">
                    <p class="name" data-audienceTypeNo="${number.audienceTypeNo }"
                       data-thicketNo="${number.ticketNo }">${number.totalNumber}</p>
                </c:forEach>
                ...
                <c:choose>
                    <c:when test="${not empty LOGIN_USER.currentPoint}">
                        <div class="point-wrap">
                            <div class="block" data-point="${LOGIN_USER.currentPoint }">
                                <button class="btn-block">${LOGIN_USER.currentPoint }</button>
                            </div>
